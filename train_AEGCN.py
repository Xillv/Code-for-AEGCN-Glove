...
class Instructor:
    def __init__(self, opt):
        ...
        self.train_data_loader = Iterator(data=absa_dataset.train_data, batch_size=opt.batch_size, shuffle=True)
        self.test_data_loader = Iterator(data=absa_dataset.test_data, batch_size=opt.batch_size, shuffle=False)
    ...
    def run(self, repeats=3):
        ...
        # criterion = CrossEntropyLoss_LSR(opt.device)
        ...
        f_out.write('max_test_acc_avg: {0}, max_test_f1_avg: {1}'.format(max_test_acc_avg / repeats,
...
if __name__ == '__main__':
    ...
    parser.add_argument('--model_name', default='aegcn', type=str)
    parser.add_argument('--dataset', default='rest15', type=str, help='twitter, lap14, rest14, rest15, rest16')
    ...
    input_colses = {
        'aegcn': ['text_indices', 'aspect_indices', 'left_indices', 'dependency_graph']
    }
    initializers = {
